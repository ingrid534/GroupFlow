...
public class GoogleCalendarAuth {
    private static final String APPLICATION_NAME = "GroupFlow";
     ...
     * @throws IOException           If client secrets not found.
     */
    ...
    /**
     * Builds the new API client service.
     * 
     * @param args arguments
     * @throws IOException              for newTrustedSupport()
     * @throws GeneralSecurityException for newTrustedSupport()
     */
