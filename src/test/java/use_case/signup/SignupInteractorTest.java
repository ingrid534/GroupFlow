...
class SignupInteractorTest {
    ...
    @Test
    void successTest() {
        SignupInputData inputData = new SignupInputData("Paul", "paul@gmail.com", "password", "password");
    ...
    void failurePasswordMismatchTest() {
        SignupInputData inputData = new SignupInputData("Paul", "paul@gmail.com", "password", "wrong");
        SignupUserDataAccessInterface userRepository = new InMemoryUserDataAccessObject();
